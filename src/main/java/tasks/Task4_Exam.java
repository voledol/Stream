...
public class Task4_Exam {
    ...
    public static Map<TruckType, List<Truck>> groupTrucksByType(List<Truck> trucks) {
        Map<TruckType, List<Truck>> map = trucks.stream()
                .collect(Collectors.groupingBy(name -> getTypeByWeight(name.getMaxWeightKg())));
        return map;
    }
    ...
    public static Map<TruckType, Long> countTrucksByType(List<Truck> trucks) {
        Map<TruckType, Long> map = trucks.stream()
                .collect(Collectors.groupingBy(name -> getTypeByWeight(name.getMaxWeightKg()), Collectors.counting()));
        return map;
    }
    ...
    public static class Truck {
        ...
        public int getMaxWeightKg() {//пришлось дописать
            return maxWeightKg;
        }
